...
def download_database():
    db_url = "https://drive.google.com/file/d/1hnwhSShZcEx6VZksfS7a-1Vmw7ogeqZp/view?usp=sharing"  # Replace with actual link
    db_path = os.path.join(working_dir, "vector_db_dir", "chroma.sqlite")
...
def setup_vectorstore():
    download_database()  # Ensure the database is downloaded
